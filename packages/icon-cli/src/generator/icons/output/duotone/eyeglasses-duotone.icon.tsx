import { memo } from 'react'
    ...
    export const EyeglassesDuotoneIcon = memo(function EyeglassesDuotone(props: SvgProps) {
        return (
    <Svg viewBox="0 0 256 256"
fill={props.color}
 ><Path d="M104,164a36,36,0,1,1-36-36A36,36,0,0,1,104,164Zm84-36a36,36,0,1,0,36,36A36,36,0,0,0,188,128Z"
opacity={0.2}
