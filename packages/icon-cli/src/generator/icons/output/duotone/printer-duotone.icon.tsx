import { memo } from 'react'
    ...
    export const PrinterDuotoneIcon = memo(function PrinterDuotone(props: SvgProps) {
        return (
    <Svg viewBox="0 0 256 256"
fill={props.color}
 ><Path d="M232,96v80H192V152H64v24H24V96c0-8.84,7.76-16,17.33-16H214.67C224.24,80,232,87.16,232,96Z"
opacity={0.2}
