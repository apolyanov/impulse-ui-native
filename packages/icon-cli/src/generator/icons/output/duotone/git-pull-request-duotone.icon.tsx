import { memo } from 'react'
    ...
    export const GitPullRequestDuotoneIcon = memo(function GitPullRequestDuotone(props: SvgProps) {
        return (
    <Svg {...props} viewBox="0 0 256 256"
fill={props.color}
 ><Path  d="M96,64A24,24,0,1,1,72,40,24,24,0,0,1,96,64ZM200,168a24,24,0,1,0,24,24A24,24,0,0,0,200,168Z"
opacity={0.2}
