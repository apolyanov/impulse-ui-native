import { memo } from 'react'
    ...
    export const MicrosoftPowerpointLogoDuotoneIcon = memo(function MicrosoftPowerpointLogoDuotone(props: SvgProps) {
        return (
    <Svg viewBox="0 0 256 256"
fill={props.color}
 ><Path d="M152,80v96a8,8,0,0,1-8,8H40a8,8,0,0,1-8-8V80a8,8,0,0,1,8-8H144A8,8,0,0,1,152,80Z"
opacity={0.2}
