import { memo } from 'react'
    ...
    export const AddressBookTabsDuotoneIcon = memo(function AddressBookTabsDuotone(props: SvgProps) {
        return (
    <Svg viewBox="0 0 256 256"
fill={props.color}
 ><Path d="M48,40a8,8,0,0,0-8,8V208a8,8,0,0,0,8,8H184V40Zm64,104a24,24,0,1,1,24-24A24,24,0,0,1,112,144Z"
opacity={0.2}
