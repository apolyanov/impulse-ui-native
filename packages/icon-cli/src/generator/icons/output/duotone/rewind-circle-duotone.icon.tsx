import { memo } from 'react'
    ...
    export const RewindCircleDuotoneIcon = memo(function RewindCircleDuotone(props: SvgProps) {
        return (
    <Svg {...props} viewBox="0 0 256 256"
fill={props.color}
 ><Path  d="M128,32a96,96,0,1,0,96,96A96,96,0,0,0,128,32ZM112,164,64,128l48-36Zm64,0-48-36,48-36Z"
opacity={0.2}
