import { memo } from 'react'
    ...
    export const SelectionForegroundDuotoneIcon = memo(function SelectionForegroundDuotone(props: SvgProps) {
        return (
    <Svg viewBox="0 0 256 256"
fill={props.color}
 ><Path d="M168,96V208a8,8,0,0,1-8,8H48a8,8,0,0,1-8-8V96a8,8,0,0,1,8-8H160A8,8,0,0,1,168,96Z"
opacity={0.2}
