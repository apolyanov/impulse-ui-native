import { memo } from 'react'
    ...
    export const VideoConferenceDuotoneIcon = memo(function VideoConferenceDuotone(props: SvgProps) {
        return (
    <Svg {...props} viewBox="0 0 256 256"
fill={props.color}
 ><Path  d="M40,48a8,8,0,0,0-8,8V200a8,8,0,0,0,8,8H160V48Zm56,96a24,24,0,1,1,24-24A24,24,0,0,1,96,144Z"
opacity={0.2}
