import { memo } from 'react'
    ...
    export const UmbrellaSimpleDuotoneIcon = memo(function UmbrellaSimpleDuotone(props: SvgProps) {
        return (
    <Svg viewBox="0 0 256 256"
fill={props.color}
 ><Path d="M224,136H32a8,8,0,0,1-8-8.71,104.37,104.37,0,0,1,207.94,0A8,8,0,0,1,224,136Z"
opacity={0.2}
