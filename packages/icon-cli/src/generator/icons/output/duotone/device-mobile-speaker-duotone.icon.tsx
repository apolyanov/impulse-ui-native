import { memo } from 'react'
    ...
    export const DeviceMobileSpeakerDuotoneIcon = memo(function DeviceMobileSpeakerDuotone(props: SvgProps) {
        return (
    <Svg viewBox="0 0 256 256"
fill={props.color}
 ><Path d="M192,40V216a16,16,0,0,1-16,16H80a16,16,0,0,1-16-16V40A16,16,0,0,1,80,24h96A16,16,0,0,1,192,40Z"
opacity={0.2}
