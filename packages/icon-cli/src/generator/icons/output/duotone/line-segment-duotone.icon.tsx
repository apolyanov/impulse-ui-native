import { memo } from 'react'
    ...
    export const LineSegmentDuotoneIcon = memo(function LineSegmentDuotone(props: SvgProps) {
        return (
    <Svg viewBox="0 0 256 256"
fill={props.color}
 ><Path d="M81,175A24,24,0,1,1,47,175,24,24,0,0,1,81,175ZM209,47A24,24,0,1,0,209,81,24,24,0,0,0,209,47Z"
opacity={0.2}
