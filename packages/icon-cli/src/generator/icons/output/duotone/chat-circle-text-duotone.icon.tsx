import { memo } from 'react'
    ...
    export const ChatCircleTextDuotoneIcon = memo(function ChatCircleTextDuotone(props: SvgProps) {
        return (
    <Svg viewBox="0 0 256 256"
fill={props.color}
 ><Path d="M224,128A96,96,0,0,1,79.93,211.11h0L42.54,223.58a8,8,0,0,1-10.12-10.12l12.47-37.39h0A96,96,0,1,1,224,128Z"
opacity={0.2}
