import { memo } from 'react'
    ...
    export const DotsSixVerticalDuotoneIcon = memo(function DotsSixVerticalDuotone(props: SvgProps) {
        return (
    <Svg {...props} viewBox="0 0 256 256"
fill={props.color}
 ><Path  d="M208,32V224a16,16,0,0,1-16,16H64a16,16,0,0,1-16-16V32A16,16,0,0,1,64,16H192A16,16,0,0,1,208,32Z"
opacity={0.2}
