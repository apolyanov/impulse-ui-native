import { memo } from 'react'
    ...
    export const DiceThreeDuotoneIcon = memo(function DiceThreeDuotone(props: SvgProps) {
        return (
    <Svg {...props} viewBox="0 0 256 256"
fill={props.color}
 ><Path  d="M216,64V192a24,24,0,0,1-24,24H64a24,24,0,0,1-24-24V64A24,24,0,0,1,64,40H192A24,24,0,0,1,216,64Z"
opacity={0.2}
