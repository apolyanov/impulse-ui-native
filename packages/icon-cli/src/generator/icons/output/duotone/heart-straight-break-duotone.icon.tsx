import { memo } from 'react'
    ...
    export const HeartStraightBreakDuotoneIcon = memo(function HeartStraightBreakDuotone(props: SvgProps) {
        return (
    <Svg {...props} viewBox="0 0 256 256"
fill={props.color}
 ><Path  d="M217.36,133.36,128,224,38.64,133.36a50,50,0,0,1,70.72-70.72L128,80l18.64-17.36a50,50,0,1,1,70.72,70.72Z"
opacity={0.2}
