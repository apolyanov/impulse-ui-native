import { memo } from 'react'
    ...
    export const PinterestLogoDuotoneIcon = memo(function PinterestLogoDuotone(props: SvgProps) {
        return (
    <Svg viewBox="0 0 256 256"
fill={props.color}
 ><Path d="M216,112c0,44.18-32,72-64,72s-41.63-21.07-41.63-21.07h0L128,88l13.14-55.83h0A80,80,0,0,1,216,112Z"
opacity={0.2}
