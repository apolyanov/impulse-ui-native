import { memo } from 'react'
    ...
    export const SuitcaseRollingDuotoneIcon = memo(function SuitcaseRollingDuotone(props: SvgProps) {
        return (
    <Svg {...props} viewBox="0 0 256 256"
fill={props.color}
 ><Path  d="M200,64V208a8,8,0,0,1-8,8H64a8,8,0,0,1-8-8V64a8,8,0,0,1,8-8H192A8,8,0,0,1,200,64Z"
opacity={0.2}
