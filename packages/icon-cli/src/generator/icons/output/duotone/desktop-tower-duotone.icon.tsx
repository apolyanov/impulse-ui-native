import { memo } from 'react'
    ...
    export const DesktopTowerDuotoneIcon = memo(function DesktopTowerDuotone(props: SvgProps) {
        return (
    <Svg viewBox="0 0 256 256"
fill={props.color}
 ><Path d="M240,48V208a8,8,0,0,1-8,8H152a8,8,0,0,1-8-8V48a8,8,0,0,1,8-8h80A8,8,0,0,1,240,48Z"
opacity={0.2}
