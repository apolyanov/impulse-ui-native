import { memo } from 'react'
    ...
    export const MicrophoneDuotoneIcon = memo(function MicrophoneDuotone(props: SvgProps) {
        return (
    <Svg viewBox="0 0 256 256"
fill={props.color}
 ><Path d="M168,64v64a40,40,0,0,1-40,40h0a40,40,0,0,1-40-40V64a40,40,0,0,1,40-40h0A40,40,0,0,1,168,64Z"
opacity={0.2}
