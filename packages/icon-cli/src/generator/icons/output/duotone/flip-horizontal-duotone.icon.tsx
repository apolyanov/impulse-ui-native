import { memo } from 'react'
    ...
    export const FlipHorizontalDuotoneIcon = memo(function FlipHorizontalDuotone(props: SvgProps) {
        return (
    <Svg {...props} viewBox="0 0 256 256"
fill={props.color}
 ><Path  d="M112,40V200a8,8,0,0,1-8,8H40a8,8,0,0,1-7.37-11.12l64-160C100,28.86,112,31.29,112,40Z"
opacity={0.2}
