import { memo } from 'react'
    ...
    export const BatteryChargingDuotoneIcon = memo(function BatteryChargingDuotone(props: SvgProps) {
        return (
    <Svg viewBox="0 0 256 256"
fill={props.color}
 ><Path d="M216,80v96a16,16,0,0,1-16,16H32a16,16,0,0,1-16-16V80A16,16,0,0,1,32,64H200A16,16,0,0,1,216,80Z"
opacity={0.2}
