import { memo } from 'react'
    ...
    export const HandDepositDuotoneIcon = memo(function HandDepositDuotone(props: SvgProps) {
        return (
    <Svg viewBox="0 0 256 256"
fill={props.color}
 ><Path d="M184,96V202.31L173.32,186a20,20,0,0,0-36.9,14H56V96a8,8,0,0,1,8-8H176A8,8,0,0,1,184,96Z"
opacity={0.2}
