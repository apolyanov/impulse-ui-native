import { memo } from 'react'
    ...
    export const CloudLightningDuotoneIcon = memo(function CloudLightningDuotone(props: SvgProps) {
        return (
    <Svg viewBox="0 0 256 256"
fill={props.color}
 ><Path d="M224,92a68,68,0,0,1-68,68H76A44,44,0,1,1,90.2,74.34v.11A68.06,68.06,0,0,1,224,92Z"
opacity={0.2}
