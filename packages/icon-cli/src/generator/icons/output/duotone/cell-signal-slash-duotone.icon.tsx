import { memo } from 'react'
    ...
    export const CellSignalSlashDuotoneIcon = memo(function CellSignalSlashDuotone(props: SvgProps) {
        return (
    <Svg {...props} viewBox="0 0 256 256"
fill={props.color}
 ><Path  d="M200,40V200a8,8,0,0,1-8,8H32a8,8,0,0,1-5.66-13.66l160-160A8,8,0,0,1,200,40Z"
opacity={0.2}
