import { memo } from 'react'
    ...
    export const ScreencastDuotoneIcon = memo(function ScreencastDuotone(props: SvgProps) {
        return (
    <Svg viewBox="0 0 256 256"
fill={props.color}
 ><Path d="M224,56V200a8,8,0,0,1-8,8H48a16,16,0,0,0-16-16V56a8,8,0,0,1,8-8H216A8,8,0,0,1,224,56Z"
opacity={0.2}
