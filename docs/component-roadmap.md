...
| Avatar                  | Available | Shared visual variants, image, initials, custom fallback, semantic status, and accessible identity.                      |
| Avatar Group            | Candidate | Overlapping group layout, maximum visible items, and overflow count.                                                     |
